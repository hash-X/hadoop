 ...
 */
public class TestNativeXORRawCoder extends TestRawCoderBase {
  ...
  @Test
  public void testCodingNoDirectBuffer_erasing_d5() {
    prepare(null, 10, 1, new int[] {5}, new int[0], true);
  ...
  @Test
  public void testCodingBothBuffers_erasing_p0() {
    prepare(null, 10, 1, new int[0], new int[] {0}, true);
